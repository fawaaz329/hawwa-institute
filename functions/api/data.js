    ...
    if (request.method === "POST") {
        try {
            ...
            if (body.action === "register") {
                ...
                if (!rData || !rData.fname || !rData.email || !rData.courses || rData.courses.length === 0) {
                ...
                const nRec = {
                    ...
                    courses: rData.courses, paymentPlan: rData.paymentPlan, totalFee: rData.totalFee, paymentMethod: rData.paymentMethod,
